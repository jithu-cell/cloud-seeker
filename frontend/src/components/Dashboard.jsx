...
function SectionHead({ label, right }) {
  return (
    <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:14 }}>
      <span style={{ fontFamily:C.sans, fontWeight:700, fontSize:10,
...
function StatCard({ label, value, sub, color, icon, loading }) {
  return (
    <Card style={{ position:"relative", overflow:"hidden" }}>
      ...
      <div style={{ fontFamily:C.sans, fontWeight:600, fontSize:10, letterSpacing:"0.15em",
                    textTransform:"uppercase", color:C.text3, marginBottom:10 }}>{label}</div>
      ...
      <div style={{ flex:1, overflowY:"auto" }}>
        ...
        {loading && (
          <div style={{ textAlign:"center", padding:"60px 0" }}>
            <div style={{ fontFamily:C.mono, fontSize:12, color:C.text3,
                          animation:"pulse 1.5s infinite" }}>fetching alerts…</div>
          </div>
        )}
          ...
          return (
            ...
            >
              ...
              <div style={{ minWidth:0 }}>
                <div style={{ fontFamily:C.sans, fontWeight:600, fontSize:13, color:C.text1,
                ...
                <div style={{ display:"flex", gap:5, flexWrap:"wrap" }}>
                  {a.region && (
                    <span style={{ fontFamily:C.mono, fontSize:9, color:C.blue,
                                   ...
                                   padding:"1px 6px", borderRadius:3 }}>{a.region}</span>
                  )}
...
function ServiceHealth() {
  return (
    <div style={{ display:"grid", gridTemplateColumns:"repeat(4,1fr)", gap:6 }}>
      {SVCS.map(s => (
        <div key={s.n} style={{ background:C.surface, border:`1px solid ${C.border}`,
          ...
          return (
            <Card key={fw.n}>
              <div style={{ display:"flex", justifyContent:"space-between", alignItems:"flex-start", marginBottom:12 }}>
                ...
                <span style={{ background:`${c}14`, border:`1px solid ${c}33`, color:c,
                               fontFamily:C.mono, fontSize:9, fontWeight:600,
          ...
          {CONFIG_RULES.map(([rule, status]) => {
            ...
            return (
              <div key={rule} style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:9 }}>
                ...
                <span style={{ background:`${c}12`, border:`1px solid ${c}30`, color:c,
                               fontFamily:C.mono, fontSize:8, fontWeight:600,
              ...
              {days.map(day => {
                ...
                return (
                  <div key={day} title={`${day}: ${count}`} style={{ flex:1, display:"flex", flexDirection:"column", alignItems:"center" }}>
                    ...
                    <div style={{ width:"100%", borderRadius:"2px 2px 0 0", minHeight:2, transition:"height 0.4s",
                                  height:`${h}%`, background:`rgba(245,158,11,${count>0?0.55:0.08})` }} />
                    <span style={{ fontFamily:C.mono, fontSize:7, color:C.text3, marginTop:4,
        ...
        <div style={{ display:"flex", alignItems:"center", gap:12 }}>
          ...
          <div>
            <div style={{ fontFamily:C.sans, fontWeight:800, fontSize:15,
                          color:C.text1, letterSpacing:"0.04em" }}>Cloud Seeker</div>
            ...
            <div style={{ display:"grid", gridTemplateColumns:"260px 1fr 240px", gap:16 }}>
                ...
                <Card>
                  ...
                  <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:8, marginBottom:16 }}>
                    {Object.entries(SEV_C).map(([sev, cfg]) => (
                      <div key={sev} style={{ background:cfg.bg, border:`1px solid ${cfg.border}`,
                        ...
                        <div style={{ fontFamily:C.sans, fontSize:8, color:cfg.fg,
                                      marginTop:4, letterSpacing:"0.1em" }}>{sev}</div>
                      </div>
                    ))}
                  </div>
              ...
              <Card style={{ display:"flex", flexDirection:"column", minHeight:580, padding:"16px 18px" }}>
                ...
                <div style={{ flex:1, overflow:"hidden" }}>
                  <AlertFeed limit={60} onNewAlert={addToast} />
                </div>
              </Card>
                  ...
                  {Object.keys(stats?.byCategory ?? {}).length === 0 ? (
                    ...
                    return (
                      <div key={cat} style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginBottom:8 }}>
                        <span style={{ background:`${cc}12`, border:`1px solid ${cc}22`, color:cc,
                                       fontFamily:C.mono, fontSize:8, padding:"1px 7px", borderRadius:3 }}>{cat}</span>
        ...
        {tab === "alerts" && (
          <div style={{ animation:"fadein 0.3s ease" }}>
            ...
            <Card style={{ minHeight:600, display:"flex", flexDirection:"column" }}>
              ...
              <div style={{ flex:1 }}>
                <AlertFeed limit={200} showAll={true} onNewAlert={addToast} />
              </div>
            </Card>
          </div>
        )}
